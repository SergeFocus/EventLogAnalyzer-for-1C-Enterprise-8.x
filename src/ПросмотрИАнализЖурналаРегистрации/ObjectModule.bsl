...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если ТипЗнч(ЭтотОбъект.КэшФильтраЖурналаРегистрации) = Тип("Структура") Тогда
		...
		Если Фильтр.ДатаОкончания.Дата > ТекущаяДата() Тогда
	...
	ИзменилосьМаксимальноеКоличествоЗаписей = ЗначениеВСтрокуВнутр(МаксимальноеКоличествоЗаписей.Значение) <> ЭтотОбъект.КэшМаксимальноеКоличествоЗаписей; 
	...
	Если ЭтотОбъект.КэшЖурналаРегистрации.Количество() = 0
		...
		ЭтотОбъект.КэшМаксимальноеКоличествоЗаписей = ЗначениеВСтрокуВнутр(МаксимальноеКоличествоЗаписей.Значение);
